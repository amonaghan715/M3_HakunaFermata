...
in_thread do
  ...
  loop do
    ...
    sample "/Users/amonaghan/ComputationalCreativity/M3_HakunaFermata/walking.wav", amp: 0.05, start: 0.15
...
in_thread do
  ...
  sample "/Users/amonaghan/ComputationalCreativity/M3_HakunaFermata/chimes.wav", amp: 1, finish: 0.8
  ...
  loop do
    ...
    if one_in(5)
      sample "/Users/amonaghan/ComputationalCreativity/M3_HakunaFermata/chimes.wav", amp: 0.35, finish: 0.8
      sleep sample_duration "/Users/amonaghan/ComputationalCreativity/M3_HakunaFermata/chimes.wav"
    end
...
in_thread do
  ...
  4.times do
    with_fx :reverb, room: 0.6 do
      sample :ambi_glass_rub, amp: a_tone, attack: 3, release: 0.5
    end
    a_tone = a_tone * 1.7
...
in_thread do
  ...
  with_fx :reverb, room: 1, mix: 0.85 do
    with_fx :echo, phase: 0.5, decay: 8, mix: 0.5 do
      use_synth :hollow
      play_chord notes, amp: 0.6, attack: 0.2, sustain: 3, release: 6
